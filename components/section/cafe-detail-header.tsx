...
export function CafeDetailHeader({
    ...
    const mainImage = thumbnail || PLACEHODER_IMAGE;
    // Prioritize menu for the "Menu / Makanan" slot, then gallery
    const sideImages = [...(menu || []), ...(gallery || [])];
    return (
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-2 h-[400px] md:h-[450px] overflow-hidden rounded-md">
                    ...
                    <div className="hidden md:flex flex-col gap-2 h-full">
                        <div className="relative flex-1 group cursor-pointer bg-muted overflow-hidden">
                            <Image
                                src={sideImages[0] || PLACEHODER_IMAGE}
                                alt="Menu or Food"
                                fill
                                className="object-cover transition-opacity duration-300 group-hover:opacity-90"
                            />
                        ...
                        <div className="relative flex-1 group cursor-pointer bg-muted overflow-hidden">
                            <Image
                                src={sideImages[1] || sideImages[0] || PLACEHODER_IMAGE}
                                alt="Gallery"
                                fill
                                className="object-cover transition-opacity duration-300 group-hover:opacity-90"
                            />
